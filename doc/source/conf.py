...
autodoc_mock_imports = ["curve_functions"]
...
project = u'fdasrsf'
copyright = u'2019, J. Derek Tucker'
...
latex_documents = [
  ('index', 'fdasrsf.tex', u'fdasrsf Documentation',
   u'J. Derek Tucker', 'manual'),
]
...
man_pages = [
    ('index', 'fdasrsf', u'fdasrsf Documentation',
     [u'J. Derek Tucker'], 1)
]
...
texinfo_documents = [
  ('index', 'fdasrsf', u'fdasrsf Documentation',
   u'J. Derek Tucker', 'fdasrsf', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = u'2019, J. Derek Tucker'
